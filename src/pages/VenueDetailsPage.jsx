...
//       <div className="w-full h-screen mx-auto py-[2%]">
//         {/* -------------------- FLEX CONTAINER -------------------- */}
...
//             <div className="bg-blue-500 rounded-xl p-[1%] shadow-md ">
//               <DeviceFilters
//                 filters={filters}
...
//   mb-4 lg:mb-0
// ">
//             <div className="bg-blue-500 rounded-xl p-3 sm:p-4 shadow-md">
//               <DeviceFilters
//                 filters={filters}
//                 setFilters={setFilters}
//                 searchTerm={searchTerm}
...
//           {/* <div className="mx-5 mb-6 md:mb-8 lg:mb-0 lg:mr-5 lg:mx-0">
