                    ...
                    <tbody>
                        {devices.map((device, index) => (
                            ...
                            >
                                ...
                                <td className="px-1 py-2 sm:py-3 text-xs sm:text-sm text-gray-700 truncate md:block hidden text-center">
                                    {device.venue}
                                </td>
                                ...
                                <td className="px-1 pr-2 sm:pr-4 py-2 sm:py-3 text-center">
                                    <button className="text-blue-600 hover:text-blue-800 text-xs sm:text-sm font-medium">Add</button>
                                </td>
                                <td className="pl-1 pr-2 py-2 sm:py-3 text-center">
                                    <button className="text-gray-600 hover:text-gray-800">
                                        <Eye className="w-4 h-4 mx-auto" />
                                    </button>
                                </td>
